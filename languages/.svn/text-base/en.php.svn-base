 ...
 */
	...
	'avatar:upload:instructions' => "Your photo is displayed throughout the site. You can change it as often as you'd like. (File formats accepted: GIF, JPG or PNG)",
	'avatar:create:instructions' => 'Click and drag a square below to match how you want your photo cropped. A preview will appear in the box on the right. When you are happy with the preview, click \'Create your photo\'. This cropped version will be used throughout the site as your photo.',
 ...
 */
	...
	'river:update:user:avatar' => '%s has a new photo',
