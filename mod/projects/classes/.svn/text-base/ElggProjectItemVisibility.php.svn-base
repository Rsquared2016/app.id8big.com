 ...
 *
 * @access private
 * @author Bortoli German <info@keetup.com>
 */
class ElggProjectItemVisibility extends ElggGroupItemVisibility {
	...
	static public function factory($container_guid) {
		...
		if (empty($cache[$cache_key])) {
			...
			if ($container && $container instanceof ProjectGroup) {
				...
				if ($is_visible) {
					...
					//Open and closed membership for this kind of groups, works in different mode.
					//
