...
$image_support = HelpBaseMain::ktform_get_entity_image_support($entity_subtype);
...
//$kt_chck = defined('Help_st_DISABLE_BULK_ACTIONS') && Help_st_DISABLE_BULK_ACTIONS != TRUE; // yes, there is one!
$kt_chck = HelpBaseMain::ktform_get_bulk_action_support($entity_subtype);
if ($kt_chck && $entity) {
	$class_chck = 'chckCont';
	if (!$icon) {
...
$owner_link = elgg_view('output/url', array(
	'href' => "help/owner/$owner->username",
	'text' => $owner->name,
	'is_trusted' => true,
));
...
$subtitle = $subtitle.elgg_view('help/listing/subtitle_extended', $vars);
...
$tags = $tags.elgg_view('help/listing/tags_extended', $vars);
