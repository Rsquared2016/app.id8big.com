...
<span class="sep"></span>
<a href="#" class="aInteract aCommentsListing" title="<?php echo $num_comments; ?> <?php echo elgg_echo('help_ktform:profile:owner:section:comments:text'); ?>"><span class="txtAI"><?php echo $num_comments; ?></span></a>
