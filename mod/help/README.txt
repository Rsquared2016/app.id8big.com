...
/mod/help/views/default/settings/help/edit.php
You should that line like this 
//run_function_once("help_ping_home");


** ABOUT ** 
Bundle de ejemplo para help en un elggbase 1.8
 
help is released under the GNU Public License (GPL), which
