...
$class_comments_tab = '';
if (!$comments) {
	$class_comments_tab = 'hidden';
}
?>
<span class="elgg-river-comments-tab <?php echo $class_comments_tab; ?>"><?php echo elgg_echo('comments'); ?></span>
<?php
if ($comments) {
...
//		$url = $object->getURL();
		$url = elgg_get_site_url() . 'theme_ajaxify/get_all_comments/' . $object->getGUID();
		$params = array(
			'href' => $url,
