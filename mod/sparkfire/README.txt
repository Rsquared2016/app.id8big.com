...
/mod/sparkfire/views/default/settings/sparkfire/edit.php
You should that line like this 
//run_function_once("sparkfire_ping_home");


** ABOUT ** 
Social Music Theme
 
sparkfire is released under the GNU Public License (GPL), which
