...
elgg.tinymce.init = function() {
	...
	tinyMCE.init({
		...
		plugins : "lists,autosave,fullscreen,paste,inlinepopups,media",
		relative_urls : false,
		remove_script_host : false,
		document_base_url : elgg.config.wwwroot,
		theme_advanced_buttons1 : "bold,italic,underline,separator,strikethrough,bullist,numlist,undo,redo,link,unlink,image,media,blockquote,code,pastetext,pasteword,more,fullscreen",
		...
		width : "100%",
		extended_valid_elements : "iframe[src|width|height|name|align|frameborder],object[classid|codebase|width|height|align|data|type|style|class|name|id],param[name|value],embed[quality|type|pluginspage|width|height|src|align|allowFullScreen|flashvars|wmode],a[name|href|target|title|onclick],img[class|src|border=0|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name|style],hr[class|width|size|noshade],font[face|size|color|style],span[class|align|style]",
		setup : function(ed) {
