...
if ($pages->prev['href']) {
	...
	echo "<li class=\"elgg-state-disabled\"><span class=\"elgg-button\">{$pages->prev['text']}</span></li>";
}

foreach ($pages->items as $page) {
	if ($page == $current_page) {
		echo "<li class=\"elgg-state-selected\"><span class=\"elgg-button\">$page</span></li>";
	} else {
...
if ($pages->next['href']) {
	...
	echo "<li class=\"elgg-state-disabled\"><span class=\"elgg-button\">{$pages->next['text']}</span></li>";
}
