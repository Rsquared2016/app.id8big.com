...
<div class="<?php echo $class; ?> ">
	...
	<div class="elgg-main elgg-body flN">
		<?php
			$show_context = array('settings');
			if(in_array($context, $show_context)) {
		?>
		<div class="bgWhiteAndShadow clearfix">
		<?php
			}
		?>
		<?php
	...
	<div class="sideBarsContainer sideBarsWidget">
		<div id="mnSidebarWidget" class="flLef">
