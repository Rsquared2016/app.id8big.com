...
if($vars['search_support'] instanceof stdClass) {
	$search_form = GtaskBaseMain::ktform_get_filter_object($vars['search_support']->plugin_name);
...
$search_link_text = elgg_echo('gtask_ktform:listing:link:search');
...
<div class="ktHiddenSrchFrm <?php echo $show_classname ?>">
	<?php
		echo elgg_view('gtask/form_wrapper', array('form' => $search_form, 'classname' => 'ktSearchForm'));
