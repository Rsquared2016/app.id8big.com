...
if(strlen($title) > Gtask_st_MAX_LENGHT_TITLE_LISTING){
	$title = elgg_get_excerpt($title, Gtask_st_MAX_LENGHT_TITLE_LISTING);
}
?>
...
?>
	<h4>
		...
		<?php
			...
			echo elgg_view('gtask/listing/info_middle_extend', $vars);
 ...
 * */
//echo elgg_view('gtask/tools/action_wheel', $vars);
