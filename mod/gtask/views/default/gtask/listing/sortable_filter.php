...
$extra_fields = GtaskBaseMain::ktform_get_extra_listing_fields($object_subtype);
...
<div class="sortingWrapper">
	<h5 class="sortingTitle"><?php echo elgg_echo('gtask:sort:title') ?></h5>
	...
	<?php
		foreach ($sortable_fields as $internalname => $options) {
			...
			$key_text = GtaskBaseMain::ktform_generate_sortable_link($internalname, $key_text);
			$li_class = 'sortableItem sortableHeader';

			$sort_type = GtaskBaseMain::ktform_camelize_string($sort_type, TRUE);
