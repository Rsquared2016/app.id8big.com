...
echo '<div>';
echo elgg_echo('gtask:group_support');
echo ' ';
echo elgg_view('input/dropdown', array(
	'name' => 'params[group_support]',
	'options_values' => array(
		'no' => elgg_echo('gtask:option:no'),
		'yes' => elgg_echo('gtask:option:yes')
	),
...
echo '<div>';
echo elgg_echo('gtask:enable_rivers_items');
echo ' ';
echo elgg_view('input/dropdown', array(
...
echo '<div>';
echo elgg_echo('gtask:profile_label_above');
echo ' ';
echo elgg_view('input/dropdown', array(
