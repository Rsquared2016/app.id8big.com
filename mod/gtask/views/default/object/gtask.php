...
if ($vars['full_view']) {
	...
	switch($display_type) {
		case 'full':
				echo elgg_view('gtask/profile_full', $vars);
			break;
		default:
				echo elgg_view('gtask/profile', $vars);
			break;
	}
	...
	switch ($option_viewtype) {
		...
		case 'full':
			echo elgg_view('gtask/listing_full', $vars);
		break;

		case 'gallery':
			echo elgg_view('gtask/gallery', $vars);
		break;

		case 'widget':
			echo elgg_view('gtask/listing_widget', $vars);
		break;

		default:
			echo elgg_view('gtask/listing', $vars);
		break;
	}
}
