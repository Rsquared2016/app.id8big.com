...
function kt_groups_init() {
	...
	elgg_extend_view('gtask_ktform_group/profile/widgets', 'groups/profileitems');
	elgg_extend_view('gtask_ktform_group/profile/left_col', 'gtask_ktform_group/profile/left_col_links', 800);

	elgg_register_page_handler('my_groups', 'kt_groups_page_handler');


	//If groups is disabled, load some libs.
	gtask_ktform_group_load_libraries();
}
 ...
 */
function gtask_ktform_group_load_libraries() {
