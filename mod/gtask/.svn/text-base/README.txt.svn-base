...
/mod/gtask/views/default/settings/gtask/edit.php
You should that line like this 
//run_function_once("gtask_ping_home");


** ABOUT ** 
Bundle de ejemplo para gtask en un elggbase 1.8
 
gtask is released under the GNU Public License (GPL), which
