...
/mod/register_exteps/views/default/settings/register_exteps/edit.php
You should that line like this 
//run_function_once("register_exteps_ping_home");


** ABOUT ** 
Extension of register module to add tabs and wizards support
 
register_exteps is released under the GNU Public License (GPL), which
