...
$pluginversion = register_exteps_get_version();
$pluginrelease = register_exteps_get_version(true);
...
system_message(elgg_echo('register_exteps:ping:thanks'));
