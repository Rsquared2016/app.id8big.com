...
/mod/news/views/default/settings/news/edit.php
You should that line like this 
//run_function_once("news_ping_home");


** ABOUT ** 
Bundle de ejemplo para news en un elggbase 1.8
 
news is released under the GNU Public License (GPL), which
