...
if ($vars['full_view']) {
	...
	switch($display_type) {
		case 'full':
				echo elgg_view('news/profile_full', $vars);
			break;
		default:
				echo elgg_view('news/profile', $vars);
			break;
	}
	...
	switch ($option_viewtype) {
		...
		case 'full':
			echo elgg_view('news/listing_full', $vars);
		break;

		case 'gallery':
			echo elgg_view('news/gallery', $vars);
		break;

		case 'widget':
			echo elgg_view('news/listing_widget', $vars);
		break;

		default:
			echo elgg_view('news/listing', $vars);
		break;
	}
}
