...
$image_support = NewsBaseMain::ktform_get_entity_image_support($entity_subtype);
...
//$kt_chck = defined('News_st_DISABLE_BULK_ACTIONS') && News_st_DISABLE_BULK_ACTIONS != TRUE; // yes, there is one!
...
$subtitle = $subtitle.elgg_view('news/listing/subtitle_extended', $vars);
...
$tags = $tags.elgg_view('news/listing/tags_extended', $vars);
