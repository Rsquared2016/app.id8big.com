...
if(strlen($title) > News_st_MAX_LENGHT_TITLE_LISTING){
	$title = elgg_get_excerpt($title, News_st_MAX_LENGHT_TITLE_LISTING);
}
?>
...
?>
	<h4>
		...
		<?php
			...
			echo elgg_view('news/listing/info_middle_extend', $vars);
...
<?php
	 ...
	 * */
	$extra_fields = NewsBaseMain::ktform_get_extra_listing_fields($entity_subtype);
 ...
 * */
//echo elgg_view('news/tools/action_wheel', $vars);
