...
$title = elgg_get_excerpt($title, NewsBaseMain::$GALLERY_TWO_ROW_MAX_TEXT);
...
$friendly_time = elgg_get_excerpt($friendly_time, NewsBaseMain::$GALLERY_ONE_ROW_MAX_TEXT);

//Owner
$owner = $vars['entity']->getOwnerEntity();
$owner_name = $owner->name;

$owner_name = elgg_get_excerpt($owner_name, NewsBaseMain::$GALLERY_ONE_ROW_MAX_TEXT);
...
<div class="ktItemGallery">
	...
	<div class="ktItemGalleryImgTop">
		...
		<div class="ktItemGalleryExtend">
			<?php echo elgg_view('news/gallery/info_title_extend', $vars);  ?>
		</div>
	</div>
