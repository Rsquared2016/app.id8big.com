...
/mod/top_notifications/views/default/settings/top_notifications/edit.php
You should that line like this 
//run_function_once("top_notifications_ping_home");


** ABOUT ** 
Agrega notificaciones visuales en la parte superior de una red social, como facebook
 
top_notifications is released under the GNU Public License (GPL), which
