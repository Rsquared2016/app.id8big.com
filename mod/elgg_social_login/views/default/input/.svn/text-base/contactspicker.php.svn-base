...
//				$options[$label] = $friend->getGUID();
				...
				if (in_array($friend->guid,$vars['value'])) {
				...
				<td>
					...
					<input type="checkbox" <?php echo $checked; ?> name="<?php echo $name; ?>[]" value="<?php echo $friend->guid; ?>" />
					<input type="hidden" name="<?php echo $name; ?>_names[<?php echo $friend->guid; ?>]" value="<?php echo $friend->name; ?>" />
				</td>
				<?php
				/*
				<td>
