...
if(array_key_exists('recaptcha_verified', $_SESSION) && $_SESSION['recaptcha_verified'] == 1) {
   ...
   $output = "<div class='rFrm clearfix'><label>" . elgg_echo('recaptcha:label:human_verification')."</label> <div class='textVerified flRig'>" . elgg_echo('recaptcha:verified') . "</div></div>";
}
else {
