 ...
 */
class PollsBaseFilter Extends PollsBaseForm {
		...
		$extra_fields = array(
			...
			array(
				...
				'input_class' => 'txtFrm txtFrm100',
				 'options' => array(
					  'placeholder' => elgg_echo('kt_polls:kt_polls_filter:label:keyword'),
				 ),
				 'label' => FALSE,
			),
			"owner" =>
			array(
				...
				'input_class' => 'txtFrm txtFrm100',
				 'options' => array(
					  'placeholder' => elgg_echo('kt_polls:kt_polls_filter:label:owner'),
				 ),
				'label' => FALSE,
