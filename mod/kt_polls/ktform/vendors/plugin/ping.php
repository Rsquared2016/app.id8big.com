...
$pluginversion = kt_polls_ktform_get_version();
$pluginrelease = kt_polls_ktform_get_version(true);
...
system_message(elgg_echo('kt_polls_ktform:ping:thanks'));
