...
/mod/kt_polls/views/default/settings/kt_polls/edit.php
You should that line like this 
//run_function_once("kt_polls_ping_home");


** ABOUT ** 
Bundle de ejemplo para kt_polls en un elggbase 1.8
 
kt_polls is released under the GNU Public License (GPL), which
