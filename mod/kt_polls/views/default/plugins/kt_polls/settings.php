...
echo '<div>';
echo elgg_echo('kt_polls:group_support');
echo ' ';
echo elgg_view('input/dropdown', array(
	'name' => 'params[group_support]',
	'options_values' => array(
		'no' => elgg_echo('kt_polls:option:no'),
		'yes' => elgg_echo('kt_polls:option:yes')
	),
...
echo '<div>';
echo elgg_echo('kt_polls:enable_rivers_items');
echo ' ';
echo elgg_view('input/dropdown', array(
...
echo '<div>';
echo elgg_echo('kt_polls:profile_label_above');
echo ' ';
echo elgg_view('input/dropdown', array(
