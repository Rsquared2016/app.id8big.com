...
if ($vars['full_view']) {
	...
	switch($display_type) {
		case 'full':
				echo elgg_view('kt_polls/profile_full', $vars);
			break;
		default:
				echo elgg_view('kt_polls/profile', $vars);
			break;
	}
	...
	switch ($option_viewtype) {
		...
		case 'full':
			echo elgg_view('kt_polls/listing_full', $vars);
		break;

		case 'gallery':
			echo elgg_view('kt_polls/gallery', $vars);
		break;

		case 'widget':
			echo elgg_view('kt_polls/listing_widget', $vars);
		break;

		default:
			echo elgg_view('kt_polls/listing', $vars);
		break;
	}
}
