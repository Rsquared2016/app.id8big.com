...
/mod/gdrive/views/default/settings/gdrive/edit.php
You should that line like this 
//run_function_once("gdrive_ping_home");


** ABOUT ** 
Bundle de ejemplo para gdrive en un elggbase 1.8
 
gdrive is released under the GNU Public License (GPL), which
