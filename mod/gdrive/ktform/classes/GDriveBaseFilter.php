 ...
 */
class GDriveBaseFilter Extends GDriveBaseForm {
		...
		$extra_fields = array(
			...
			array(
				...
				'input_class' => 'txtFrm txtFrm100',
				 'options' => array(
					  'placeholder' => elgg_echo('gdrive:gdrive_filter:label:keyword'),
				 ),
				 'label' => FALSE,
			),
			"owner" =>
			array(
				...
				'input_class' => 'txtFrm txtFrm100',
				 'options' => array(
					  'placeholder' => elgg_echo('gdrive:gdrive_filter:label:owner'),
				 ),
				'label' => FALSE,
