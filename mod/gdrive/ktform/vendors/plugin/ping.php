...
$pluginversion = gdrive_ktform_get_version();
$pluginrelease = gdrive_ktform_get_version(true);
...
system_message(elgg_echo('gdrive_ktform:ping:thanks'));
