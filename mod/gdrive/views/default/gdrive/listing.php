...
$image_support = GDriveBaseMain::ktform_get_entity_image_support($entity_subtype);
...
//$kt_chck = defined('GDrive_st_DISABLE_BULK_ACTIONS') && GDrive_st_DISABLE_BULK_ACTIONS != TRUE; // yes, there is one!
...
$owner_link = elgg_view('output/url', array(
	'href' => "gdrive/owner/$owner->username",
	'text' => $owner->name,
	'is_trusted' => true,
));
...
$subtitle = $subtitle.elgg_view('gdrive/listing/subtitle_extended', $vars);
...
$tags = $tags.elgg_view('gdrive/listing/tags_extended', $vars);
...
if (!empty($entity->alternative_link)) {
    $title_link = elgg_view('output/url', array(
		...
		'href' => $entity->getURL(),
		'is_trusted' => true,
        'class' => 'gdrive-auth gdrive-google',
    ));
