...
if($vars['search_support'] instanceof stdClass) {
	$search_form = GDriveBaseMain::ktform_get_filter_object($vars['search_support']->plugin_name);
...
$search_link_text = elgg_echo('gdrive_ktform:listing:link:search');
...
<div class="ktHiddenSrchFrm <?php echo $show_classname ?>">
	<?php
		echo elgg_view('gdrive/form_wrapper', array('form' => $search_form, 'classname' => 'ktSearchForm'));
