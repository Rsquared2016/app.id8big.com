...
// Make sure we actually have permission to edit
	...
	if($entity) {
		...
		// Success message
			system_message(sprintf(elgg_echo("events_ktform:delete:entity:deleted"), elgg_echo('item:object:'.$subtype)));

		} else {
			register_error(sprintf(elgg_echo("events_ktform:delete:entity:not_deleted"), elgg_echo('item:object:'.$subtype)));
		}
	} else {
		register_error(sprintf(elgg_echo("events_ktform:delete:entity:not_deleted"), elgg_echo('item:object:'.$subtype)));
	}
