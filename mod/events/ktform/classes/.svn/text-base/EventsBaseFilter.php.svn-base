 ...
 */
class EventsBaseFilter Extends EventsBaseForm {
		...
		$extra_fields = array(
			...
			array(
				...
				'input_class' => 'txtFrm txtFrm100',
				 'options' => array(
					  'placeholder' => elgg_echo('events:events_filter:label:keyword'),
				 ),
				 'label' => FALSE,
			),
			"owner" =>
			array(
				...
				'input_class' => 'txtFrm txtFrm100',
				 'options' => array(
					  'placeholder' => elgg_echo('events:events_filter:label:owner'),
				 ),
				'label' => FALSE,
