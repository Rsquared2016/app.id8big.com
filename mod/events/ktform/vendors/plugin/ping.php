...
$pluginversion = events_ktform_get_version();
$pluginrelease = events_ktform_get_version(true);
...
system_message(elgg_echo('events_ktform:ping:thanks'));
