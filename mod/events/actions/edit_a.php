...
if ($all_day == 'yes' ) {
    ...
    $start_time = '0';
    $end_time = '84600';
    set_input('start_time', $start_time);
    set_input('end_date', $star_date);
    set_input('end_time', $end_time);
}
...
if (elgg_get_plugin_setting('enable_rivers_items', 'events') == 'yes') {
...
if ($success) {
	...
	if ($entity) {
		...
		// Success message
		system_message(sprintf(elgg_echo("events_ktform:save:entity:saved"), elgg_echo('item:object:'.$subtype)));
