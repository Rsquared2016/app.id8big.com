...
//events_ktform_get_trimed_title().
$title = $entity->title;
if (!$title) {
	$title = $entity->name;
}
...
if(strlen($title) > Events_st_MAX_LENGHT_TITLE_LISTING){
	$title = elgg_get_excerpt($title, Events_st_MAX_LENGHT_TITLE_LISTING);
}
?>
...
?>
	<h4>
		...
		<?php
			...
			echo elgg_view('events/listing/info_middle_extend', $vars);
 ...
 * */
//echo elgg_view('events/tools/action_wheel', $vars);
