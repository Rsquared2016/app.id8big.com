...
<div class='ktFormCont'>
	...
	<div class="goBackBreadCrumb">
		...
		$go_back_link = '#';
		$go_back_text = elgg_echo('events_ktform:profile:full:go:back');
	...
	<div class='ktFormButtonsCont'>
		<?php
			...
			echo elgg_view('events/profile_full/buttons', $vars);
		?>
		<div class="clearfloat">&nbsp;</div>
	</div>
	...
	<div class='ktFormUserInfo'>
		...
		<div class="likesAndMore">
			<?php
				...
				echo elgg_view('events/profile/owner_section', $vars)
			?>
		</div>
		<div class="clearfloat">&nbsp;</div>
	</div>
	<?php /** You can extend anything over here **/ ?>
	<?php echo elgg_view('events/profile_full/profile_footer') ?>
</div>
