...
/mod/events/views/default/settings/events/edit.php
You should that line like this 
//run_function_once("events_ping_home");


** ABOUT ** 
Bundle de ejemplo para events en un elggbase 1.8
 
events is released under the GNU Public License (GPL), which
