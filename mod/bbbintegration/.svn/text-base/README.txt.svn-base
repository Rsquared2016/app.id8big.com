...
/mod/meeting/views/default/settings/meeting/edit.php
You should that line like this 
//run_function_once("meeting_ping_home");


** ABOUT ** 
Bundle de ejemplo para meeting en un elggbase 1.8
 
meeting is released under the GNU Public License (GPL), which
