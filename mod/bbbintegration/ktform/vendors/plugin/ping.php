...
$pluginversion = meeting_ktform_get_version();
$pluginrelease = meeting_ktform_get_version(true);
...
system_message(elgg_echo('meeting_ktform:ping:thanks'));
