...
/**
 * MeetingBaseForm profile display
 *
...
if ($vars['full_view']) {
	...
	switch($display_type) {
		case 'full':
				echo elgg_view('meeting/profile_full', $vars);
			break;
		default:
	...
	switch ($option_viewtype) {
		...
		case 'full':
			echo elgg_view('meeting/listing_full', $vars);
		break;
		...
		case 'widget':
			echo elgg_view('meeting/listing_widget', $vars);
		break;
