...
class MeetingFormFilter extends MeetingBaseFilter {
	...
	public function __construct($form_vars = array()) {
		...
		//	$this->setFormAction($CONFIG->url.'meeting/search/');
		...
		$fields = array(
			...
			"keyword" => array(
				...
				'label' => FALSE,
				'options' => array(
					'placeholder' => elgg_echo('meeting_ktform:filter:label:keyword'),
				),
			),
			"owner" => array(
				'type' => 'text',
				...
				'label' => FALSE,
				'options' => array(
					'placeholder' => elgg_echo('meeting_ktform:filter:label:owner'),
				),
			),
//			'tags' => array(
//				'type' => 'text',
...
//				 'options' => array(
//					'placeholder' => elgg_echo('meeting_ktform:filter:label:tags'),
//				),
