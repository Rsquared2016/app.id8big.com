...
/mod/circles/views/default/settings/circles/edit.php
You should that line like this 
//run_function_once("circles_ping_home");


** ABOUT ** 
This module allows you to group your friends in circles, similar to google plus
 
circles is released under the GNU Public License (GPL), which
