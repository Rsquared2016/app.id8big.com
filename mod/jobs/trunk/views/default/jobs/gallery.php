...
$title = elgg_get_excerpt($title, KtJobBaseMain::$GALLERY_TWO_ROW_MAX_TEXT);
...
$friendly_time = elgg_get_excerpt($friendly_time, KtJobBaseMain::$GALLERY_ONE_ROW_MAX_TEXT);

//Owner
$owner = $vars['entity']->getOwnerEntity();
$owner_name = $owner->name;

$owner_name = elgg_get_excerpt($owner_name, KtJobBaseMain::$GALLERY_ONE_ROW_MAX_TEXT);
...
<div class="ktItemGallery">
	...
	<div class="ktItemGalleryImgTop">
		...
		<div class="ktItemGalleryExtend">
			<?php echo elgg_view('jobs/gallery/info_title_extend', $vars);  ?>
		</div>
	</div>
