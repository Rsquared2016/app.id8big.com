...
if (empty($file_options['subtype'])) {
	$_SESSION[KtJob_st_FILE_NAME][$file_options['type']][$internalname] = $save_to_session;
} else {
	$_SESSION[KtJob_st_FILE_NAME][$file_options['type']][$file_options['subtype']][$internalname] = $save_to_session;
}
