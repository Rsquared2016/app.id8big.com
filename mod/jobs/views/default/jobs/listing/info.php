...
if(strlen($title) > KtJob_st_MAX_LENGHT_TITLE_LISTING){
	$title = elgg_get_excerpt($title, KtJob_st_MAX_LENGHT_TITLE_LISTING);
}
?>
...
?>
	<h4>
		...
		<?php
			...
			echo elgg_view('jobs/listing/info_middle_extend', $vars);
...
<?php
	 ...
	 * */
	$extra_fields = KtJobBaseMain::ktform_get_extra_listing_fields($entity_subtype);
 ...
 * */
//echo elgg_view('jobs/tools/action_wheel', $vars);
