...
if ($vars['full_view']) {
	...
	switch($display_type) {
		case 'full':
				echo elgg_view('jobs/profile_full', $vars);
			break;
		default:
				echo elgg_view('jobs/profile', $vars);
			break;
	}
	...
	switch ($option_viewtype) {
		...
		case 'full':
			echo elgg_view('jobs/listing_full', $vars);
		break;

		case 'gallery':
			echo elgg_view('jobs/gallery', $vars);
		break;

		case 'widget':
			echo elgg_view('jobs/listing_widget', $vars);
		break;

		default:
			$vars['view_type'] = 'listing';
			echo elgg_view('jobs/listing', $vars);
		break;
	}
}
