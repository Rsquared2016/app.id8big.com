...
/mod/jobs/views/default/settings/jobs/edit.php
You should that line like this 
//run_function_once("jobs_ping_home");


** ABOUT ** 
Bundle de ejemplo para jobs en un elggbase 1.8
 
jobs is released under the GNU Public License (GPL), which
