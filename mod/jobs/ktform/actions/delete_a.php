...
// Make sure we actually have permission to edit
	...
	if($entity) {
		...
		// Success message
			system_message(sprintf(elgg_echo("jobs_ktform:delete:entity:deleted"), elgg_echo($subtype)));

		} else {
			register_error(sprintf(elgg_echo("jobs_ktform:delete:entity:not_deleted"), elgg_echo($subtype)));
		}
	} else {
		register_error(elgg_echo("jobs_ktform:delete:entity:not_deleted"));
	}
	if (elgg_is_admin_logged_in()){
